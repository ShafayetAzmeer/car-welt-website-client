...
const ExplorePurchase = () => {
    const { allProductID } = useParams();
    const [purchase, setPurchase] = useState({});
    const {user} = useAuth();

    useEffect(() => {
        fetch(`https://fierce-lake-25951.herokuapp.com/allProductDetail/${allProductID}`)
          .then((res) => res.json())
    ...
    const onSubmit = (data) => {
       ...
       fetch("https://fierce-lake-25951.herokuapp.com/confirmAllProductPurchase", {
        method: "POST",
...
export default ExplorePurchase;